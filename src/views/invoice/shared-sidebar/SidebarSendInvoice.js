...
const SidebarSendInvoice = ({open, toggleSidebar, companyEmail, companyName}) => {
    return (
        <Sidebar
            size='lg'
            open={open}
        ...
        >
            <Form>
                <div className='mb-1'>
                    ...
                    <Input id='invoice-from' defaultValue='sales@dashingdisty.com' placeholder='company@email.com'/>
                </div>
                <div className='mb-1'>
                    <Label for='invoice-to' className='form-label'>
                        To
                    </Label>
                    <Input id='invoice-to' defaultValue={companyEmail} placeholder='company@email.com'/>
                </div>
                <div className='mb-1'>
                    ...
                    <Input
                        id='invoice-subject'
                        defaultValue='Invoice of purchased products from DDS'
