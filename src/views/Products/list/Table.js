...
const UsersList = () => {
    ...
    const [{data, loading}, refetch] = useAxios(`${PUBLIC_API_URL}/api/product?page=${currentPage}&limit=${rowsPerPage}&search=${search}`)
    ...
    return (<Fragment>
        ...
        <Sidebar open={sidebarOpen} toggleSidebar={toggleSidebar} refetch={refetch}/>
    </Fragment>)
}
